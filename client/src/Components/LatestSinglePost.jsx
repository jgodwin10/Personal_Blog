...
const LatestSinglePost = ({ title, img, slug }) => {
  return (
    <div className="flex mb-6 md:w-[100%]  border border-neutral-600 rounded-xl">
      <div className={`w-[40%] rounded-xl rounded-e-none`}>
        <img className="w-[100%] h-full rounded-s-xl" src={img} alt={title} />
      </div>
      <div className="flex flex-col justify-center py-4 px-3 lg:px-5">
