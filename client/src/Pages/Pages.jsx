...
import { useFetchPageQuery } from "../App/PostSlice";
import { useParams } from "react-router-dom";
import { Helmet } from "react-helmet-async";
import ScrollToTop from "../Components/ScrollToTop";

const Pages = () => {
  const { pagesSlug } = useParams();
  const { data, isLoading, isError, error } = useFetchPageQuery();
  ...
  const posts = data?.find((post) => post.slug == pagesSlug);
